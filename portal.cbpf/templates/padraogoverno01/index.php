            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div id="logo" class="span8<?php if($this->params->get('classe_nome_principal', '') != '') echo ' '.$this->params->get('classe_nome_principal'); ?>">
                        <a href="principal" title="<?php echo $this->params->get('nome_principal', 'Nome principal'); ?>">
        ...
        <footer>
            ...
            <div class="footer-logos">
                <div class="container">
                    <?php if( $this->params->get('rodape_acesso_informacao', 1) == 1 ): ?>
                        <a href="http://www.acessoainformacao.gov.br/"tar target="_blanck" class="logo-acesso pull-left"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/acesso-a-informacao.png" alt="Acesso a Informação"></a>
                    <?php endif; ?>
                    <?php if( $this->params->get('rodape_logo_brasil', 1) == 1 ): ?>
                        <!-- separador para fins de acessibilidade --><span class="hide">&nbsp;</span><!-- fim separador para fins de acessibilidade -->
                        <a href="http://www.brasil.gov.br/"tar target="_blanck" pull-right class="brasil pull-right"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/brasil.png" alt="Brasil - Governo Federal"></a>
                    <?php endif; ?>
                </div>
            </div>
            <div class="footer-ferramenta">
                <div class="container">
                  ...
                  <?php  echo $this->params->get('mensagem_final_ferramenta', 
                                                   
                                                 
                                                 
                                                   
                          '<p>Rua Dr. Xavier Sigaud, 150 - Urca - Rio de Janeiro - RJ - Brasil - CEP: 22290-180 | Tel.: +55 (21) 2141-7100 / Fax: +55 (21) 2141-7400 | <a href="/index.php/creditos-de-desenvolvimento/">Cr&eacute;ditos de Desenvolvimento</a></p>'); ?>
